...
<ul class="ul">
<li><a href="${path}/item/queryItemByCondtion.do?pageNo=1"><samp class="t05"></samp>商品录入/上下架</a></li>
...
<li><a href="${path}/item/brand/listBrand.do"><samp class="t05"></samp>品牌管理</a></li>
</ul>